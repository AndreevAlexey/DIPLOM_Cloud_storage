...
public class Constant {
    ...
    public static final String EQL_FILE_NAMES = "Имена файлов совпадают!";
    public static final String EMPTY_FILE_NAME = "Не указано имя файла!";
    public static final String WRN_LIST_LIM = "Неверно указан лимит!";
    ...
    public static final String EMPTY_LOG_PASS = "Не указан логин или пароль!";

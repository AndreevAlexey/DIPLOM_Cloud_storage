...
import cloud_storage.repository.UserFileCrudRepository;
...
public class CloudRepositoryTests {
    ...
    void test_login_thrown_WRN_USR_PASS() {
        ...
        Assertions.assertThrows(ErrorInputData.class, () -> cloudRepository.login(username, password));
    }
    ...
    void test_uploadFile_throw_ERR_FILE_EXISTS() {
        ...
        // then
        Assertions.assertTrue(id.isPresent());
        Assertions.assertThrows(ErrorInputData.class, () -> cloudRepository.uploadFile(filename1, file));
    }
    ...
    void test_editFileName_throw_ERR_FILE_EXISTS() {
        ...
        cloudRepository.uploadFile(filename1, file);
        // then
        Assertions.assertThrows(ErrorInputData.class, () -> cloudRepository.editFileName(filename1, filename1));
    }
    ...
    void test_editFileName_throw_FILE_NOT_FOUND() {
        ...
        // then
        Assertions.assertThrows(ErrorInputData.class, () -> cloudRepository.editFileName(filename1, "new.txt"));
    }
    ...
    void test_deleteFile_throw_FILE_NOT_FOUND() {
        ...
        // then
        Assertions.assertThrows(ErrorInputData.class, () -> cloudRepository.deleteFile(filename1));
    }
    ...
    void test_downloadFile_throw_FILE_NOT_FOUND() {
        ...
        // then
        Assertions.assertThrows(ErrorInputData.class, () -> cloudRepository.downloadFile(filename1));
    }
